...
ENV PATH="$HOME/app/.venv/bin:$PATH" \
    ...
    UV_LINK_MODE=copy \
    HF_HOME=$HOME/.vox/cache/huggingface \
    HUGGINGFACE_HUB_CACHE=$HOME/.vox/cache/huggingface/hub \
    VOX_PRELOAD_TURN_DETECTOR=livekit \
    HF_XET_CACHE=$HOME/.vox/cache/huggingface/xet \
