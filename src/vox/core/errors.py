...
class AdapterExecutionBusyError(VoxError):
    def __init__(self) -> None:
        super().__init__("adapter execution capacity is exhausted")


class ModelTrimUnsupportedError(VoxError):
    def __init__(self, model: str) -> None:
        self.model = model
        super().__init__(f"model '{model}' does not support memory trimming")
